                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input name="title" type="text" value="{{ old('title') }}" class="form-control" placeholder="Nhập tiêu đề bài viết" onchange="changeInput(this.value)">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Slug</label>
                                <input id="slug" name="slug" type="text" value="{{ old('slug') }}" class="form-control" placeholder="Nhập đường dẫn URL">
                            </div>
                            <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    @if($category->parent_id ==0)
                                                        ...
                                                        {{ $category->prefix }} {{ $category->name }}  <i class="fa fa-caret-down"></i>
                                                    @else
                                                        <input type="checkbox" name="category[]" value="{{ $category->id }}"/>
